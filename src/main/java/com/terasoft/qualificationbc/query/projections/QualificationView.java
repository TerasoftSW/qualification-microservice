...
public class QualificationView {
    ...
    public QualificationView(String qualificationId, String comment, Integer score, String lawyerId, String customerId, String customLegalCaseId, String legalAdviceId, Instant createdAt) {
